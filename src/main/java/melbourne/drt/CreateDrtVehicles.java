...
public class CreateDrtVehicles {
	...
	public static void main(String[] args) {
		...
		String networkfile = "C:/Users/Joschka/Dropbox/melbourne-berlin/scenario/drt-scenario/input/YarraRangesNetworkMix.xml";
		String taxisFile = "C:/Users/Joschka/Dropbox/melbourne-berlin/scenario/drt-scenario/input/taxis_"
				+ numberofVehicles + ".xml";
		List<Vehicle> vehicles = new ArrayList<>();

		Random random = MatsimRandom.getLocalInstance();
		new MatsimNetworkReader(scenario.getNetwork()).readFile(networkfile);
		// near Lilydale station
		Link startLink = scenario.getNetwork().getLinks().get(Id.createLinkId(18821));
